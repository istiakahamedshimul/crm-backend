...
public class VehiclesController(CrmDbContext db) : ControllerBase
{
    ...
    [HttpPost, backend.Security.RequirePermission(PermissionCodes.TransportationManage)]
    ...
    [HttpPut("{id:int}"), backend.Security.RequirePermission(PermissionCodes.TransportationManage)]
    ...
    [HttpPatch("{id:int}/status"), backend.Security.RequirePermission(PermissionCodes.TransportationManage)]
