...
public class VehiclesController(CrmDbContext db) : ControllerBase
{
    ...
    [HttpPost, Authorize(Roles = "SuperAdmin,Transportation")]
    ...
    [HttpPut("{id:int}"), Authorize(Roles = "SuperAdmin,Transportation")]
    ...
    [HttpPatch("{id:int}/status"), Authorize(Roles = "SuperAdmin,Transportation")]
