...
namespace backend.Migrations
{
    ...
    [Migration("20260829071431_AddAdvancedReportingAndDueWorkflow")]
    partial class AddAdvancedReportingAndDueWorkflow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.CustomerDue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.CustomerDueAudit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CustomerDueId");

                    b.ToTable("CustomerDueAudits");
                });

            modelBuilder.Entity("backend.Models.DailyWorkReport", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("InputLanguage")
                        .IsRequired()
                        .HasColumnType("longtext");
                    ...
                    b.HasIndex("SalesExecutiveId", "WorkDate")
                        .IsUnique();

                    b.ToTable("DailyWorkReports");
                });
            ...
            modelBuilder.Entity("backend.Models.LeadAssignmentHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int?>("FromSalesExecutiveId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ToSalesExecutiveId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.LeadStatusHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("backend.Models.MonthlyCollection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SalesExecutiveId", "Month")
                        .IsUnique();

                    b.ToTable("MonthlyCollections");
                });

            modelBuilder.Entity("backend.Models.MonthlyCollectionAudit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("MonthlyCollectionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MonthlyCollectionId");

                    b.ToTable("MonthlyCollectionAudits");
                });

            modelBuilder.Entity("backend.Models.MonthlySalesTarget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("MinimumCollectionAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("MinimumSalesUnits")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.ReportAccessAudit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("backend.Models.SalesGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.SalesGroupTarget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("CollectionTarget")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("SalesGroupId", "Month")
                        .IsUnique();

                    b.ToTable("SalesGroupTargets");
                });

            modelBuilder.Entity("backend.Models.SalesTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SalesGroupId", "Name")
                        .IsUnique();

                    b.ToTable("SalesTeams");
                });

            modelBuilder.Entity("backend.Models.SalesTeamTarget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SalesTeamId", "Month")
                        .IsUnique();

                    b.ToTable("SalesTeamTargets");
                });
            ...
            modelBuilder.Entity("backend.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("LocationTrackingChangedAtUtc")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("backend.Models.CustomerDue", b =>
                {
                    ...
                    b.HasOne("backend.Models.User", "PaidBy")
                        .WithMany()
                        .HasForeignKey("PaidById")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("backend.Models.User", "RecordedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.CustomerDueAudit", b =>
                {
                    b.HasOne("backend.Models.CustomerDue", "CustomerDue")
                        .WithMany()
                        .HasForeignKey("CustomerDueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CustomerDue");
                });
            ...
            modelBuilder.Entity("backend.Models.Lead", b =>
                {
                    ...
                    b.HasOne("backend.Models.Customer", "PreviousCustomer")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.MonthlyCollectionAudit", b =>
                {
                    b.HasOne("backend.Models.MonthlyCollection", "MonthlyCollection")
                        .WithMany()
                        .HasForeignKey("MonthlyCollectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MonthlyCollection");
                });
            ...
            modelBuilder.Entity("backend.Models.SalesGroup", b =>
                {
                    b.HasOne("backend.Models.User", "GroupLeader")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.SalesGroupTarget", b =>
                {
                    b.HasOne("backend.Models.SalesGroup", "SalesGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.SalesTeam", b =>
                {
                    b.HasOne("backend.Models.SalesTeam", "ParentTeam")
                        .WithMany()
                    ...
                    b.HasOne("backend.Models.User", "TeamLeader")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.SalesTeamTarget", b =>
                {
                    b.HasOne("backend.Models.SalesTeam", "SalesTeam")
                        .WithMany()
