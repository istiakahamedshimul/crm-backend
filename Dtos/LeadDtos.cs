...
public record CreateLeadRequest(string CustomerName, string Phone, string? AlternativePhone, string? Email, string? Address, string? BudgetRange, string? PreferredLocation, int? ProjectId, LeadSource Source, LeadPriority Priority, int? AssignedToId, string? Remarks);
