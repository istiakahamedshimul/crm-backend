...
public record UpdateSalesExecutiveRequest(string FullName, string Email, string Phone, bool IsActive, string? Password, int MinimumSalesUnits, decimal MinimumCollectionAmount, DateOnly? TargetMonth);
